build:
	...
	clang++ -c -std=c++11 controllers/AngularTestControllerComplete.cpp
	...
	clang++ -c -std=c++11 controllers/PicsControllerComplete.cpp
	clang++ -c -std=c++11 controllers/TestControllerComplete.cpp
	clang++ -shared -fPIC -Wl,-soname,debug.so -o modules/debug.so ControllerBase.o ControllerFactoryBase.o AngularTestControllerComplete.o
	...
	clang++ -shared -fPIC -Wl,-soname,debug.so -o modules/debug.so ControllerBase.o ControllerFactoryBase.o PicsControllerComplete.o
